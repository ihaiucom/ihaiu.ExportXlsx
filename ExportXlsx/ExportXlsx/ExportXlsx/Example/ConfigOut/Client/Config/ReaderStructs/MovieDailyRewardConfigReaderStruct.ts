...
namespace configs
{
	...
	export class MovieDailyRewardConfigReaderStruct extends CsvConfigRender<    MovieDailyRewardConfig      >
	{
		path = "MovieDailyReward";


        ParseCsv(csv: string[] )
        {
			let config = new MovieDailyRewardConfig();
