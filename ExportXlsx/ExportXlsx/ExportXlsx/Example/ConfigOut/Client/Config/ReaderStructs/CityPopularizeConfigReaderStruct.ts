...
namespace configs
{
	...
	export class CityPopularizeConfigReaderStruct extends CsvConfigRender<    CityPopularizeConfig      >
	{
        ...
        ParseCsv(csv: string[] )
        {
			...
			config.level_three_chance = csvGetInt(csv,  this.GetHeadIndex(  "level_three_chance"  )   );
			...
			config.level_seven_chance = csvGetInt(csv,  this.GetHeadIndex(  "level_seven_chance"  )   );
			...
			config.level_ten_chance = csvGetInt(csv,  this.GetHeadIndex(  "level_ten_chance"  )   );
			...
			config.level_fifteen_chance = csvGetInt(csv,  this.GetHeadIndex(  "level_fifteen_chance"  )   );
			...
			config.level_twenty_chance = csvGetInt(csv,  this.GetHeadIndex(  "level_twenty_chance"  )   );
