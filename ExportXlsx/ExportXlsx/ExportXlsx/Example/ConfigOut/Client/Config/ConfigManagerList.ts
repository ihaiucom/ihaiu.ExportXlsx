...
namespace configs
{
    ...
    export class ConfigManagerList
    {
        ...
        mediaVisit  : MediaVisitConfigReader = new MediaVisitConfigReader();
        ...
        movieRandomName  : MovieRandomNameConfigReader = new MovieRandomNameConfigReader();
        ...
        storyStack  : StoryStackConfigReader = new StoryStackConfigReader();
        ...
        initList()
        {
            ...
            this.renders.push(this.mediaVisit);
            ...
            this.renders.push(this.movieRandomName);
            ...
            this.renders.push(this.storyStack);
