...
export default class BlockLevelConfigStruct extends BaseConfig
{
	...
	get name():string
	{
		let value = <string> LangManager.Instance.getValue("blockLevel", this.id, "name");
	...
	{
		let value = <string[]> LangManager.Instance.getValue("blockLevel", this.id, "current_msg");
		if (!isNullOrEmpty(value))
		{
			return value;
		}
	...
	get next_msg():string[]
	{
		let value = <string[]> LangManager.Instance.getValue("blockLevel", this.id, "next_msg");
		if (!isNullOrEmpty(value))
		{
			return value;
		}
	...
	{
		let value = <string> LangManager.Instance.getValue("blockLevel", this.id, "name_tips");
		if (!isNullOrEmpty(value))
		{
			return value;
		}
